...
import cn.edu.ahnu.wjcy.myapplication.Model.eventBus.PayEvent;
...
public class JPushReceiver extends BroadcastReceiver {
	...
	private void processCustomMessage(Bundle bundle) {
		...
		if(!TextUtils.isEmpty(message)){
			...
			if(userInfo!=null&&!TextUtils.isEmpty(userInfo.getOpenid())&&!TextUtils.isEmpty(userInfo.getPhonenum())){
				EventBus.getDefault().post(new PayEvent(userInfo));
			}
		}
	}
}
